    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${tc}ee 0%, ${tc} 60%, ${tc}bb 100%)` }}>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-white/60 text-xs font-bold tracking-[0.35em] uppercase mb-2">Refund Policy</p>
            <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tight">Cancellation &amp; Refund</h1>
          </div>
        </div>
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-12">
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 sm:p-10">
          {settings?.pageCancellationRefund ? (
            <div className="legal-content" dangerouslySetInnerHTML={{ __html: settings.pageCancellationRefund }} />
          ) : (
