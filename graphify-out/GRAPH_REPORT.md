# Graph Report - C:\Users\OmAgrawal\Downloads\dashboardaistudio  (2026-05-06)

## Corpus Check
- 110 files · ~117,977 words
...
Cohesion: 0.06
Nodes (25): toggleSelect(), getMetaCreds(), getNextAssignee(), buildEmailHtml(), concurrencyLimit(), createLead(), createTransport(), DELETE() (+17 more)
...
- **Thin community `Community 23`** (2 nodes): `page.tsx`, `RootPage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (2 nodes): `robots.ts`, `robots()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
